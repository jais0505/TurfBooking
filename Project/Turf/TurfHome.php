...
<br />
<a href="TurfProfile.php">Profile</a>
<a href="Time.php">Time</a>
<a href="ViewUserBooking.php">View Bookings</a>
<a href="EditProfile.php">Edit Profile</a>
<a href="ChangePassword.php">Change Password</a>
<a href="ViewComplaints.php">ViewComplaints</a>
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="ml-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <li><a href="TurfProfile.php" class="nav-link">Profile</a></li>
              <li><a href="Time.php">Time</a></li>
              <li><a href="ViewUserBooking.php"  class="nav-link">View Bookings</a></li>
             
              <li><a href="ViewComplaints.php" class="nav-link">ViewComplaints</a><li>
              <li><a href="TurfHome.php" class="nav-link">Home</a><li>
              <li><a href="../Guest/Logout.php" class="nav-link">Logout</a><li>
              </ul>
            </nav>
        ...
        <div class="row align-items-center">
          <div class="col-lg-5 ml-auto">
            ...
            <p>
             ...
             <a href="User\BookTurf.php" class="green-button">Book Turf</a>
